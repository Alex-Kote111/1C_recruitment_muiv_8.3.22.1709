...
Процедура ПриОткрытии(Отказ)
	...
	Если Объект.ИсточникПривлечения = ПредопределенноеЗначение("Справочник.ИсточникиПривлечения.ХэдХантер") ИЛИ Объект.ИсточникПривлечения = ПредопределенноеЗначение("Справочник.ИсточникиПривлечения.СайтУниверситета") Тогда
