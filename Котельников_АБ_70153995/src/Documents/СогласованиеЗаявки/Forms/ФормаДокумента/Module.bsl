...
Функция ПолучитьОтветственногоЗаЗаявку(ЗаявкаНаПодбор)
	...
	УстановитьОтветственногоВЗаявкеИСтатус(ЗаявкаНаПодбор, ОтветственныйЗаЗаявку);
...
&НаСервереБезКонтекста
Процедура УстановитьОтветственногоВЗаявкеИСтатус(ЗаявкаНаПодбор, ОтветственныйЗаЗаявку)
