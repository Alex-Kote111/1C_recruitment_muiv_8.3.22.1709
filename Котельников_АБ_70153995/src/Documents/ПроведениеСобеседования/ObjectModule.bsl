...
Процедура ЗаписатьРезультатПервичногоСобеседованияВРегистр()
	...
	Если СтатусСобеседования = Перечисления.СтатусыСобеседований.Запланировано Тогда 
		Движение.Период = Дата;
	Иначе
		Движение.Период = ДатаСобеседования;
	КонецЕсли;
...
Процедура ОбработкаПроверкиЗаполнения(Отказ, ПроверяемыеРеквизиты)
	...
	Если СтатусСобеседования = Перечисления.СтатусыСобеседований.Запланировано Тогда
		ПроверяемыеРеквизиты.Удалить(ПроверяемыеРеквизиты.Найти("РезультатСобеседования"));
	КонецЕсли;
